...
RUN depshortname=$(curl --connect-timeout 10 -s https://cdn.atriarch.systems/File/cdn-wfe/ab91225aa4ee457899a9e0368e253ebd |awk -v shortname="mc" -F, '$1==shortname {$1=""; print $0}') \
