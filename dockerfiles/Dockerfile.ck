...
RUN depshortname=$(curl --connect-timeout 10 -s https://raw.githubusercontent.com/GameServerManagers/Demonslyr/master/lgsm/data/ubuntu-22.04.csv |awk -v shortname="ck" -F, '$1==shortname {$1=""; print $0}') \
